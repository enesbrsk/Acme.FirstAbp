...
namespace Acme.FirstAbp.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update FirstAbpDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update FirstAbpEfCoreEntityExtensionMappings to extend the IdentityUser entity
